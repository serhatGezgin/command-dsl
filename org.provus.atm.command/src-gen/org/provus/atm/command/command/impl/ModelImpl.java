 ...
 * <ul>
 *   <li>{@link org.provus.atm.command.command.impl.ModelImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return CommandPackage.Literals.MODEL;
  }
  ...
  public EList<Command> getCommands()
  {
    if (commands == null)
    {
      commands = new EObjectContainmentEList<Command>(Command.class, this, CommandPackage.MODEL__COMMANDS);
    }
    return commands;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CommandPackage.MODEL__COMMANDS:
