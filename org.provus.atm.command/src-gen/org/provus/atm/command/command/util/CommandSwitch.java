/**
 */
package org.provus.atm.command.command.util;
...
public class CommandSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        ENC enc = (ENC)theEObject;
        T result = caseENC(enc);
        if (result == null) result = caseCommand(enc);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case CommandPackage.PASS:
      {
        ...
        if (result == null) result = caseCommand(pass);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>ENC</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>ENC</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseENC(ENC object)
  {
    return null;
  }
